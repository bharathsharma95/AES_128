...
//const unsigned char Rcon[8] = {
//    0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80};

//round constant for 256
//const unsigned char Rcon[7] = {
...
void aes_enc_dec(unsigned char state[256], unsigned char key[176], unsigned char dir)
{
  ...
  for (round = 0; round < 10; round++)
    {
		...
		else
		{
		    ...
		    if ((round > 0 && dir) || (round < 9 && !dir))
			{
    			...
    			} // end " if ((round > 0 && dir) || (round < 9 && !dir)) "
